...
const menuItems = [
    ...
    },
    {
        ...
        submenu: [
            ...
            { title: 'Packing', path: '/admin/order/status', key: 'PACKING', values: ['READY_TO_SHIP', 'CANCELLED'] },
            { title: 'Ready to Ship', path: '/admin/order/status', key: 'READY_TO_SHIP', values: ['SHIPPED', 'CANCELLED'] },
            ...
            { title: 'Out For Delivery', path: '/admin/order/status', key: 'OUT_FOR_DELIVERY', values: ['SHIPPED', 'CANCELLED'] },
