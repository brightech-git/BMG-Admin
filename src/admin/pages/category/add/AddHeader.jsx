    ...
    useEffect(()=>{
        if(editingData){
            setForm({
                ...
                isCategory:editingData?.CATEGORY === "Yes" ?? "",
                isActive:editingData?.ACTIVE === "Yes" ?? "",
        ...
        <div className="max-w-xl mx-auto mt-8">
            <div className="border rounded-lg overflow-hidden">
                ...
                <form onSubmit={handleSubmit} className="p-5 space-y-4">
                    ...
                    <div className="grid grid-cols-2 gap-3">
                        ...
                        <div>
                            ...
                            <input
                                ...
                                placeholder="e.g. about"
                                className={`mt-1 w-full border rounded px-2.5 py-1.5 text-xs ${isDuplicateKey ? "border-red-400 bg-red-50" : ""
                                    }`}
                            />
                            {isDuplicateKey && (
                    ...
                    {/* value */}
                    <div>
                        <label className="text-xs font-medium text-gray-600">Value (route) *</label>
                        <input
                            value={form.value}
                    ...
                    <div className="flex items-center gap-6 bg-gray-50 rounded-md px-4 py-3 border">
                        ...
                        {/* hide isCategory once a category already exists */}
                        {!isCategoryDone && (
                            <Switch
                                checked={form.isCategory}
                                onChange={set("isCategory")}
                                label="Is category"
                            />
                        )}
                    </div>
