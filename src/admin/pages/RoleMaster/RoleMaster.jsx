                ...
                <div className={`w-full max-w-lg rounded-2xl overflow-hidden shadow-lg ${isDark ? 'bg-gray-900' : 'bg-white'}`}>
                    ...
                    <div className="bg-gradient-to-r from-orange-500 to-orange-600 p-1 sm:p-2">
                        <div className="flex items-center gap-3">
                            ...
                            <div>
                                <h1 className="text-white font-semibold text-lg leading-tight">Add Role</h1>
                                <p className="text-orange-100 text-xs mt-0.5">Create a new role for the admin panel</p>
                            </div>
                        </div>
                    </div>
            ...
            >
                ...
                >
                    <div className="p-2 md:p-3">
                        ...
                        {/* ── Empty state ── */}
                        {!isLoading && displayedRoles.length === 0 && (
