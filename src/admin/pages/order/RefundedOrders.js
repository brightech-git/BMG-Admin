...
import { CancelledOrdersPage } from './OrderPages';
        ...
        >
                                    ...
                                    filteredOrders.map((order) => (
                                        <React.Fragment key={order.id}>
                                            <TableRow sx={{ '&:hover': { backgroundColor: 'var(--active-bg)' } }}>
                                                ...
                                                <TableCell>
                                                    <Box>
                                                        <Typography variant="body2" sx={{ fontWeight: 600, color: 'var(--primary-text-color)', fontFamily: 'var(--font-secondary)', fontSize: 'var(--font-size-xs)' }}>
                                                            {order.user_name}
                                                        </Typography>
                                                        <Typography variant="caption" sx={{ color: 'var(--secondary-text-color)', fontFamily: 'var(--font-secondary)', fontSize: 'var(--font-size-xs)' }}>
                                                            {order.email}
                                                        </Typography>
                                                    </Box>
                                                </TableCell>
                                                <TableCell align="right">
                                                    <Typography variant="body1" sx={{ fontWeight: 700, color: 'var(--primary-color)', fontFamily: 'var(--font-secondary)', fontSize: 'var(--font-size-sm)' }}>
                                                ...
                                                <TableCell>
                                                    <Typography variant="body2" sx={{ fontWeight: 500, fontFamily: 'var(--font-secondary)', fontSize: 'var(--font-size-xs)' }}>
            ...
            <Dialog
                ...
                PaperProps={{
                    sx: {
                        backgroundColor: 'var(--card-background-color)',
                        color: 'var(--primary-text-color)', fontFamily: 'var(--font-secondary)'
                    }
                }}
            >
