...
import { useUploadFeaturedBannerMutation, useUpdateFeaturedBannerMutation, useFeaturedBannersQuery } from "../../../hooks/banners/FeatureProductsBanner/useFeatureBanner";
import {
    Box,
    Button,
    TextField,
...
const UploadFeatureDesign = () => {
    ...
    const updateMutation = useUpdateFeaturedBannerMutation();
