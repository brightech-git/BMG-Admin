...
import { useUploadOfferBannerMutation ,useUpdateOfferBannerMutation } from '../../../hooks/banners/offerBanner/useUploadOfferBanner';
...
import { useBannersQuery } from '../../../hooks/banners/offerBanner/useOfferBannerQuery';
...
const AddOfferBanner = () => {
    ...
    const uploadMutation = useUploadOfferBannerMutation();
    const updateMutation = useUpdateOfferBannerMutation();
    ...
    const handleSubmit = async (e) => {
        ...
        if (isEdit) {
            updateMutation.mutate({ formData: payload, id: editId }, {
                onSuccess: () => {
                    setSuccess("Banner updated successfully.");
                    setTimeout(() => {
                        navigate("/offerbanner/manage"); // go back to list (change if needed)
                    }, 700);
                },
                onError: (err) => {
            ...
            uploadMutation.mutate(payload, {
                onSuccess: () => {
                    ...
                    setTimeout(() => {
                        navigate("/offerbanner/manage"); // go back to list
                    }, 700);
                },
                onError: (err) => {
            ...
            <div className="">
                <div className="flex items-center justify-between">
                    <h2 className="text-sm font-semibold mb-1">
                        {isEdit ? "Edit Offer Banner" : "Add New Offer Banner"}
                    </h2>
                    <button
                        type="button"
                        onClick={() => navigate(-1)}
