...
import { useUploadFestivalBannerMutation ,useUpdateFEstivalBannerMutation } from '../../../hooks/banners/FestivalBanner/useFestivalBanner';
...
const AddFestivalBanner = () => {
    ...
    const uploadMutation = useUploadFestivalBannerMutation();
    const updateMutation = useUpdateFEstivalBannerMutation();
        ...
        if (isEdit) {
            updateMutation.mutate(payload, {
                onSuccess: () => {
                    ...
                    setTimeout(() => {
                        navigate("/festivalbanner/manage"); // go back to list (change if needed)
                    }, 700);
                },
                onError: (err) => {
            ...
            uploadMutation.mutate(payload, {
                onSuccess: () => {
                    ...
                    setTimeout(() => {
                        navigate("/festivalbanner/manage"); // go back to list
                    }, 700);
                },
                onError: (err) => {
            ...
            <div className="">
                <div className="flex items-center justify-between mb-1">
                    <h2 className="text-sm font-semibold ">
                        {isEdit ? "Edit Festival Banner" : "Add New Festival Banner"}
                    </h2>
                    <button
                        type="button"
                        onClick={() => navigate(-1)}
