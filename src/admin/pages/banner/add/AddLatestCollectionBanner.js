...
import { useUploadLatestBannerMutation, useUpdateLatestBannerMutation, useLatestBannersQuery } from "../../../hooks/banners/latestCollection/useLatestCollection";
import {
    Box,
    Button,
    TextField,
...
console.log(state ,'state')
    ...
    // queries / mutations
    const { data: bannersData, isLoading: bannersLoading } = useLatestBannersQuery();
    ...
    const uploadMutation = useUploadLatestBannerMutation();
    const updateMutation = useUpdateLatestBannerMutation();
    ...
    const currentBanner = useMemo(() => {
        ...
        return banners.find((b) => (b.id) === (editId)) || null;
    }, [isEdit, editId, banners]);
console.log(currentBanner ,'banner')
            ...
            <div className="">
                <div className="flex items-center justify-between">
                    <h2 className="text-sm font-semibold mb-1">
                        {isEdit ? "Edit LatestCollection Banner" : "Add LatestCollection Banner"}
                    </h2>
                    <button
                        type="button"
                        onClick={() => navigate(-1)}
                ...
                <form onSubmit={handleSubmit} className="space-y-2">
                    ...
                    <div>
                        <label className="block text-xs font-medium  mb-1">
                            Banner ItemCrtName <span className="text-red-500">*</span>
                        </label>
                        <select
                            value={title}
...
export default UploadLatestBanner;
