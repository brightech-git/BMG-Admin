...
import { useUploadLatestBannerMutation } from "../../../hooks/banners/latestCollection/useLatestCollection";
import {
    Box,
    Button,
    TextField,
        ...
        <Box sx={{ padding: 4, margin: "0px auto", mt: { xs: 2, md: 3 } }}>
            ...
            >
                <Typography variant="h6" sx={{ mb: 3, fontWeight: 700 }}>
                    Upload Latest Collection Banner
                </Typography>
