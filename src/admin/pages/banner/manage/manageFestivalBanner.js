...
const ManageFestivalBanner = () =>{
    const navigate = useNavigate();
        ...
        const { mutate: deleteBanner } = useDeleteFestivalBannerMutation();
    ...
    const handleOnClick = () => {
        navigate('/admin/festivalbanner/add')
    }
    return(
        <div className="max-w-8xl mx-auto mt-4 p-3 sm:p-4 sm:mt-4">
            <BannerTable
                title="Manage Festival Banners"
                    ...
                    if (key === "actions") {
                        return (
                            <div className="flex gap-2 justify-center">
                                <button
                                    onClick={() => navigate('/admin/festivalbanner/add', { state: { id: row.id, mode: 'edit' } })}
