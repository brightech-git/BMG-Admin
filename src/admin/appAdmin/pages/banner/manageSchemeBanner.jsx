...
import { getAllSliders, deleteSlider } from "../../service/schemeBannerService";

const SchemeBannerTable = () => {
                    ...
                    if (key === "actions") {
                        return (
                            <div className="flex gap-2 justify-center">
                                <button
                                    onClick={() =>
                                        navigate("/app/admin/schemeBanner/add", {
...
export default SchemeBannerTable;
