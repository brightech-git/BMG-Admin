...
import { getAllSliders, updateSlider } from "../../service/schemeBannerService";

const UpdateSchemeBanner = () => {
    ...
    useEffect(() => {
        if (sliders.length > 0 && editId) {
            const current = sliders.find((s) => Number(s.SchemeId) === Number(editId));
    ...
    const handleSubmit = async (e) => {
        ...
        formData.append("schemeId", editId);
    ...
    return (
        <div className="max-w-7xl mx-auto mt-8 p-2 border">
            <div className="flex items-center justify-between mb-3">
                <h2 className="text-sm font-semibold">Edit Scheme Banner</h2>
                <button
                    type="button"
                    onClick={() => navigate(-1)}
...
export default UpdateSchemeBanner;
